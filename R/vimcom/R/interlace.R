...
vim.interlace.rnoweb <- function(rnwf, rnwdir, latexcmd = "latexmk",
...
vim.interlace.rrst <- function(Rrstfile, rrstdir, compiler = "rst2pdf", ...) {
    if (!require(knitr))
        stop("Please, install the 'knitr' package.")
...
vim.interlace.rmd <- function(Rmdfile, outform = NULL, rmddir, ...) {
